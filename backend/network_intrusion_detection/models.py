...
class NetworkIntrusionDetectionModel(CoreModel):
    ...
    packet_size = models.TextField(verbose_name="数据包大小", default="无")
    flow_duration = models.TextField(verbose_name="流持续时间", default="无")
    transport_layer = models.TextField(verbose_name="传输层协议", default="无")
    application_layer = models.TextField(verbose_name="应用层协议", default="无")
    traffic_type = models.TextField(verbose_name="流量类型", default="无")
    attack_type = models.TextField(verbose_name="攻击类型", default="无")
    app_data_size = models.TextField(verbose_name="应用数据大小", default="无")
