<template>
    <div>
        ...
        <el-row gutter="15" class="mb-15">
            <el-col :span="5">
                <el-card class="card-item">
                    <el-text class="mx-1" tag="b" size="large">节点告警处理进度</el-text>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="31" status="exception" striped
                        striped-flow :duration="10" class="mt-15">
                        <span>北京节点01 31%</span>
                    </el-progress>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="41" status="exception" striped
                        striped-flow :duration="10" class="mt-15">
                        <span>上海节点02 41%</span>
                    </el-progress>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="61" status="warning" striped
                        striped-flow :duration="10" class="mt-15">
                        <span>广州节点03 61%</span>
                    </el-progress>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="71" status="warning" striped
                        striped-flow :duration="10" class="mt-15">
                        <span>深圳节点04 71%</span>
                    </el-progress>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="91" striped striped-flow
                        :duration="10" status="successful" class="mt-15">
                        <span>武汉节点05 91%</span>
                    </el-progress>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="95" striped striped-flow
                        :duration="10" status="success" class="mt-15">
                        <span>成都节点06 95%</span>
                    </el-progress>
                    <el-progress :text-inside="true" :stroke-width="25" :percentage="97" striped striped-flow
                        :duration="10" status="success" class="mt-15">
                        <span>杭州节点07 97%</span>
                    </el-progress>
                </el-card>
...
<script lang="ts">
import { onMounted, onBeforeUnmount, onActivated, defineComponent, ref, reactive } from 'vue';
    ...
    setup() {
        ...
        const initGradientChart = () => {
            if (gradientChartRef.value) {
                ...
                const eventTypes = ['后门攻击', 'DoS攻击', 'DDoS攻击', 'SQL注入攻击', '中间人攻击'];
                const colors = ['#ff6f00', '#ffab00', '#f57f17', '#ff8f00', '#ff5722'];

                const generateRandomData = () => Array.from({ length: 7 }, () => Math.round(Math.random() * 100));
